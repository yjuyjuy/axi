...
| [`mattermost-axi`](https://github.com/yjuyjuy/mattermost-axi)                                          | yjuyjuy            | Mattermost                       | Read threads and attachments, search posts, and reply in threads with token-efficient TOON output and --json contracts; credentials from MM_TOKEN and MM_SERVER_URL only.                                                                            |
